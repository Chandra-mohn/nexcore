#!/bin/bash
# Check status of Nex Docker services
#
# Usage:
#   ./status.sh
...
echo "+==============================================================+"
echo "|               NEX DOCKER ENVIRONMENT STATUS                  |"
echo "+==============================================================+"
echo ""
...
echo "RESOURCE USAGE:"
echo "---------------"
docker stats --no-stream --format "table {{.Name}}\t{{.CPUPerc}}\t{{.MemUsage}}" 2>/dev/null | grep nex || echo "  No containers running"
